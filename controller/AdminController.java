...
public class AdminController {
	...
	public String orderStat(String day, HttpServletRequest request) {
		if (day == null || "".equals(day) ){
			SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
			day = dateFormat.format( new Date() );
		}
		request.setAttribute("day", day);
		List<Orders> orderList = orderService.getDayList(day);
		int tt = 0;
	...
	public String adminReset(Admins admin, HttpServletRequest request, HttpSession session) {
		request.setAttribute("flag", 5);
		Admins ad = adminService.get(admin.getId());
		if (ad != null && ad.getPassword().equals(SafeUtil.encode(admin.getPassword()))) {
			...
			request.setAttribute("admin", adminService.getByUsername(uname));
